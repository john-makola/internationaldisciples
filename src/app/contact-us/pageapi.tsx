      ...
      <main className="max-w-4xl mx-auto px-4 py-16 text-gray-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            />
            {errors.inquiry && (
              <p className="text-sm text-red-600">{errors.inquiry}</p>
            )}
          ...
          <div className="bg-gray-100 p-6 rounded-lg shadow">
            <h2 className="text-xl font-bold mb-3 text-[#802E2F]">Our Address</h2>
            ...
            <p>
              <strong>Email:</strong>{" "}
              <a href="mailto:info@internationaldisciples.com" className="underline">
