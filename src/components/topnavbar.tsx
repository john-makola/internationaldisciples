...
const navItems = [
  ...
  },
  {
    ...
    subMenu: [
      ...
      { name: "Prayer Ministry ", linkUrl: "prayerministry" },
    ],
  },
  {
    title: "Events",
    ...
    <header className="fixed top-0 left-0 w-full shadow-md bg-white z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between flex-wrap bg-red">
        ...
        <div className="flex items-center space-x-4">
          ...
          <p className="text-sm md:text-lg font-semibold text-gray-800 max-w-xs md:max-w-none uppercase text-center">
            International Disciples Mission
          ...
          {navItems.map(({ title, subMenu }) => (
            <div key={title} className="relative group">
              <div
                ...
                className="flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 gap-x-2 cursor-pointer"
              >
                <span>{title}</span>
      ...
      {menuOpen && (
        <div className="md:hidden px-4 pb-4 space-y-4">
          ...
          <Link
            ...
            className="block text-sm text-gray-700 font-medium hover:text-blue-600"
          >
            Home
          </Link>
